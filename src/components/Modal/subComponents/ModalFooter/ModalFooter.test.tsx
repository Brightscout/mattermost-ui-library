...
describe('Modal Footer', () => {
    ...
    describe('Modal Footer - disabled footer buttons', () => {
        beforeEach(() => {
            component = mount(<ModalFooter {...modalFooterProps} cancelDisabled confirmDisabled />);
        })
    ...
    describe('Modal Footer - correctly render the passed button text props for confirm and cancel buttons', () => {
        beforeEach(() => {
            component = mount(<ModalFooter {...modalFooterProps} confirmBtnText={confirmBtnText} cancelBtnText={cancelBtnText} />);
        })
